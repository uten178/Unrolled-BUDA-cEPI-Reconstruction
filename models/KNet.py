...
def KNet(data_consistency_type,
         num_rows,
         num_cols,
         num_coils,
         num_GD_blocks=10,
    ...
    if use_DL_regularizer:
        ...
        reg_model = UNet2D(im_size=num_rows, kernel_size=3, num_out_chan_highest_level=64,
        ...
        if pretrained_reg_net_path is not None:
            reg_model.load_weights(pretrained_reg_net_path)
